...
public class Actualtofflecontent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actualtofflecontent);
        context=this;
        //videoView=findViewById(R.id.videoview);
        listView=findViewById(R.id.lvideo);
        listView.setAdapter(new customlist3(this,prgmNameList,prgmImages));
