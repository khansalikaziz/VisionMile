...
public class paymentgatewaytrialpage extends AppCompatActivity implements PaymentResultListener {
    Button B;
    TextView pay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paymentgatewaytrialpage);
    ...
    public void onPaymentSuccess(String s) {
        ...
        ielts = FirebaseDatabase.getInstance().getReference().child("Users").child("Customers").child(customerid).child("ielts");
        ielts.setValue("0");
        startActivity(new Intent(paymentgatewaytrialpage.this,Actualcoursecontent.class));
    }
