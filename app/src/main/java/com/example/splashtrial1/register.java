    ...
    private void uploadpicture() {
        ...
        riversRef.putFile(imageUri)
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(register.this, "image upload fail", Toast.LENGTH_SHORT).show();
            }
        });
                                ...
                                auth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            ...
                                            DatabaseReference quizscore=customersDatabaseRef.child("quiz");
                                            quizscore.setValue("0");
                                            SharedPreferences preferences1 = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                                            SharedPreferences.Editor editor = preferences1.edit();
                                            editor.putString("username", String.valueOf(name));
                                            editor.apply();


                                            startActivity(new Intent(register.this, login_activity.class));
                                            Toast.makeText(register.this, "Account created successfully please verify your mail", Toast.LENGTH_SHORT).show();
                                            dialog.dismiss();
